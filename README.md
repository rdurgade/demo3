...
```sh
$ cd $GOPATH/src
$ git clone https://github.com/opsinfra/demo3.git
```
...
4. Replace name demo3 in main.go with new project name
```sh
Example:
    $ cd $GOPATH/src/mysvc
    $ sed -i '' "s/demo3/${PWD##*/}/g" main.go  # On Linux, this line would be sed -i main.go "s/demo3/${PWD##*/}/g"
```
